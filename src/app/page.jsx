      ...
      <Card className="mx-auto md:p-2 md:max-w-5xl sm:max-w-sm">
        <CardHeader>
          <CardTitle className="text-xl">
            Registro Sector P&uacute;blico
          </CardTitle>
          <CardDescription>
                  ...
                  <div className="grid gap-4 sm:gap-2 md:grid-cols-2 md:gap-4">
                    <div className="grid gap-2">
                      <Label htmlFor="institucion">
                        Instituci&oacute;n P&uacute;blica
                      </Label>
                      <Input
                        id="institucion"
                        placeholder="Nombre de Instituci&oacute;n"
                        required
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor="posicion">Cargo Laboral</Label>
                      <Input
                        id="posicion"
                        placeholder="Coloque su cargo"
                        required
                        {...register("posicion")}
                      />
